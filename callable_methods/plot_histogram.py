...
filehandler = logging.FileHandler("/home/omsens/Documents/results_experiments/logging/plotting.log")
...
def plot_variable(filename_path, runs_path, variable, time_value):
    ...
    # Set number of bins
    binwidth = 0.1
    bins = np.linspace(np.round(min(vals), 3), np.round(max(vals), 3), 1 / binwidth)
