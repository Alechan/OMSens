...
def sweepAndPlotFromJSON(dest_folder_path_base, json_file_path, communicator=None):
    ...
    for var_name in full_json["vars_to_analyze"]:
        ...
        sweep_plotter.plotInFolder(var_name, plot_path_without_extension, with_upper_and_lower)
