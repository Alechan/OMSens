...
equation
    ...
    der(intWageRate)=wageRate;
annotation(
    experiment(StartTime = 0, StopTime = 35, Tolerance = 1e-6, Interval = 1),
    __OpenModelica_simulationFlags(lv = "LOG_STATS", s = "dassl"));end GoodwinKeen;