subroutine curvifgr_simplified(x0, obj_func, lower_bounds, upper_bounds, epsilon, n, x_opt, f_opt)
    ! Declarations
    implicit none
    integer, intent(in) :: n
...
!    double precision :: fopt_tmp
    ...
    external obj_func, curvifgr,curvif
